...
from hyram_vps.inference.memory_manager import MemoryManager
from hyram_vps.inference.object_manager import ObjectManager
from hyram_vps.inference.image_feature_store import ImageFeatureStore
from hyram_vps.model.hyram_vps import HyRAMVPS
from hyram_vps.utils.tensor_utils import pad_divide_by, unpad, aggregate
...
class InferenceCore:
    ...
    def _add_memory(self,
        ...
        msk_value, sensory, obj_value, region_summary_aux = self.network.encode_mask(
            image,
            pix_feat,
        ...
        if self.save_aux:
            self.memory.region_summary_aux = region_summary_aux
    ...
    def step(self,
        ...
        self.curr_ti += 1
        if self.save_aux:
            self.memory.region_summary_aux = None
